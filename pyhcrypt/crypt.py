...
def generate_states():
	...
	return {"h_rand": get_rand_bytes(MAX_DIGEST_SIZE), "t_rand": get_rand_bytes(MAX_DIGEST_SIZE), "h_key": get_rand_bytes(MAX_DIGEST_SIZE), "t_key": get_rand_bytes(MAX_DIGEST_SIZE), "h_salt": get_rand_bytes(MAX_DIGEST_SIZE), "t_salt": get_rand_bytes(MAX_DIGEST_SIZE), "h_person": get_rand_bytes(MAX_DIGEST_SIZE), "t_person": get_rand_bytes(MAX_DIGEST_SIZE), "key_key": get_rand_bytes(MAX_KEY_SIZE), "key_salt": get_rand_bytes(SALT_SIZE), "key_person": get_rand_bytes(PERSON_SIZE), "salt_key": get_rand_bytes(MAX_KEY_SIZE), "salt_salt": get_rand_bytes(SALT_SIZE), "salt_person": get_rand_bytes(PERSON_SIZE), "person_key": get_rand_bytes(MAX_KEY_SIZE), "person_salt": get_rand_bytes(SALT_SIZE), "person_person": get_rand_bytes(PERSON_SIZE)}
...
def encrypt_bytes(bytesin, passwd, use_rand=use_rand_default):
	...
	_content = hash_blake(get_rand_bytes(MAX_DIGEST_SIZE), digest_size=MAX_DIGEST_SIZE, key=hash_key, salt=hash_salt, person=hash_person).digest() if use_rand else hash_blake(states["h_rand"] + passwd + states["t_rand"], digest_size=MAX_DIGEST_SIZE, key=hash_key, salt=hash_salt, person=hash_person).digest()
...
def encrypt_stream(fin, passwd, use_rand=use_rand_default):
	...
	if use_rand:
		_content = hash_blake(get_rand_bytes(MAX_DIGEST_SIZE), digest_size=MAX_DIGEST_SIZE, key=hash_key, salt=hash_salt, person=hash_person).digest()
